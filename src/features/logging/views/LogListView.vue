...
<template>
 ...
 <template v-if="isLoading">
   ...
   <div class="loader" role="status" aria-label="Loading logs">
 ...
 <template v-else-if="loadingError">
  ...
  <template v-else-if="!logStore.logs || logStore.logs.length === 0">
   ...
   <PageStatusMessage 
        title="No Log Found!"
        message="Sorry. No log were found matching your filter requirements."
        icon="inbox"
        :is-standalone="true">
       <template #actions>
  ...
  <template v-else>
    ...
    <header class="page-header container">
      <h1 class="page-header__title">
        ...
        <button class="btn btn--primary" @click="modalStore.push('LogListFilter', 'Filter Logs')">Filter</button>
    </header>
