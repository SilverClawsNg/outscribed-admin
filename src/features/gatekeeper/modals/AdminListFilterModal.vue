...
import { useAdminListFilterStore } from '../stores/AdminListFilterStore'
import { useModalStore } from '@/stores/modalStore'
import { GeneralSortTypeSelectItems, CountrySelectItems, RoleTypeSelectItems } from '@/utils/selectItemHelper'
  ...
  <div class="form-container">
   ...
   <!-- 3. Dataset Result Record Filtering Parameters -->
      <section>
        ...
        <fieldset>
                <select v-model="filterStore.role"  class="form-field">
                    <option value="-1">-- by role --</option>
