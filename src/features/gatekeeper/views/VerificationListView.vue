...
<template>
 ...
 <template v-if="isLoading">
  ...
  <div class="loader" role="status" aria-label="Loading verifications">
 ...
 <template v-else-if="loadingError">
  ...
  <template v-else-if="!verificationStore.verifications || verificationStore.verifications.length === 0">
   ...
   <PageStatusMessage 
        ...
        message="Sorry. No verification were found matching your filter requirements."
        icon="inbox"
        :is-standalone="true">
       <template #actions>
  ...
  <template v-else>
     ...
     <header class="page-header container">
      <h1 class="page-header__title">
        ...
        <button class="btn btn--primary" @click="modalStore.push('VerificationListFilter', 'Filter Verification')">Filter</button>
    </header>
