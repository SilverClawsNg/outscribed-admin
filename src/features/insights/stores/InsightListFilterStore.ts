...
import { ref } from 'vue';
import { getValidSortType, getValidDateScope, getValidInsightStatus, getValidCountry, getValidCategory
...
function getAsDictionary(): Record<string, string> {
  ...
  return {
    sort, startdate, enddate, scope, keyword, pointer, username, bypasscache, country, category, taleid, tag, creatorid, status,
