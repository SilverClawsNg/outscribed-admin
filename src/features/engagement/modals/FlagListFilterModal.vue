...
import { GeneralSortTypeSelectItems, LimitedContentTypeSelectItems, FlagTypeSelectItems } from '@/utils/selectItemHelper'
      ...
      <section>
        <h3 class="form-heading">Filter</h3>
         ...
         <fieldset>
             ...
             <fieldset>
                <select v-model="filterStore.flagtype"  class="form-field">
                    <option value="-1">-- by type --</option>
                    <option v-for="item in FlagTypeSelectItems" :key="item.value" :value="item.value">
                    {{ item.label }}
                    </option>
                </select>
            </fieldset>
