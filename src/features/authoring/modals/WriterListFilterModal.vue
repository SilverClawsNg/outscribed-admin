...
import { GeneralSortTypeSelectItems, WriterStatusSelectItems,  CountrySelectItems
        ...
        <h3 class="form-heading">Filter</h3>
         ...
         <fieldset>
                <select v-model="filterStore.status"  class="form-field">
                    ...
                    <option v-for="item in WriterStatusSelectItems" :key="item.value" :value="item.value">
                    {{ item.label }}
                    </option>
                </select>
            </fieldset>
